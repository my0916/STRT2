...
- __Optional__
   ...
   | `-d, --dta` | | Add `-d, --dta` (downstream-transcriptome-assembly) if you plan to perform TFE-based analysis.<br>Please note that this leads to fewer alignments with short-anchors.|
   | `-h, --help`| | Show usage.|
...
```
This outputs a set of files with suffixes. Here, `canFam3_reference.1.ht2`, `canFam3_reference.2.ht2`, `canFam3_reference.3.ht2`, `canFam3_reference.4.ht2`, `canFam3_reference.5.ht2`, `canFam3_reference.6.ht2`, `canFam3_reference.7.ht2`, `canFam3_reference.8.ht2` are generated.
